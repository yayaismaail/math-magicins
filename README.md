...
**[Math Magicians]** is a project that uses a Single Page Application format to display items on a page, so that a user can switch to a page where a live calculator which can be used for computation is.
...
Feel free to check the [issues page](https://github.com/yayaismaail/math-magicians/issues).
...
This project is [MIT](https://github.com/yayaismaail/math-magicians/blob/development/LICENSE) licensed.
